  ...
  <view>
            ...
            <view class="cu-timeline">
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >没有原型，也就是没有业务流程图，无法设计UI图，请先提供完整业务原型，或前往沟通洽谈，原型付费设计：100+元/页（不谈价）</view
                  >
                </view>
              </view>
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >请提供表述完整的原型图，确定设计风格、主题颜色、配色要求等，如难以表述，可提供相关案例图片作为设计参考</view
                  >
                </view>
              </view>
              <view class="cu-time">
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >设计时间我们会根据需求给予及相关流程进行评估，例如：业务流程/原型设计完善，且页面数量在20页内，设计时间约为7个工作日（参考）</view
                  >
                </view>
              </view>
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >根据提供的UI设计需求，双方沟通讨论，并对UI设计需求的合理性和可行性分析，确认无误后，包含图标设计，UI设计价格为：200-500元/页</view
                  >
                </view>
              </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >设计需求确认后，客户需要支付（支持多种付款方式）最终报价费用的50%作为定金，并提供确认人员的电话及邮箱</view
                  >
                </view>
              </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >收到定金后，根据最终沟通的设计需求，首页首先进行效果图设计，且将首页UI图发送客户初步确认</view
                  >
                </view>
              </view>
            ...
            <view class="cu-timeline">
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >类型：首先确认需要设计开发的小程序类型，例如：工具类、电商类、内容资讯类、生活服务类、游戏娱乐类等。</view
                    >
                    <view class="margin-top-sm"
                      >资质：如果是个人资质，那么限制很多（许多功能无法上线），有个体工商营业执照，或者企业资质是最好的。同时有已认证好的公众号也可以直接复用资质给小程序账号</view
                    >
                  </view>
                </view>
              </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >如果您没有服务器，可自行上阿里云或腾讯云购买，更或者我们协助您购买（因为云服务器购买需要实名认证，而服务器我们只能替您配置好并存放项目，服务器的拥有权还是您的，如果有需求，可提供代管理）</view
                    >
                    <view class="margin-top-sm"
                      >阿里云建议使用支付宝账号进行注册然后绑定手机号，并完成实名认证。</view
                    >
                  </view>
                </view>
              </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >根据功能点及相关实现难点，给予评估报价，实现包括：“原型流程、UI设计、后台开发、前端开发、项目上线”，如果能提供原型流程图，是最好的</view
                  >
                </view>
              </view>
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >开发时长往往取决于小程序/App类型或相关功能点，一般小程序/App开发上线时长在：2-3个月</view
                  >
                </view>
              </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >客户在项目开始着手开发前，支付最终报价费用的50%作为定金，并以541形式收取（定金50%，上线40%，确认无误10%）</view
                  >
                </view>
              </view>
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >支持多种类型付款方式：微信、支付宝、转账等，可提供电子发票（不含税费）</view
                  >
                </view>
              </view>
              ...
              <view class="cu-item text-blue" style="padding-bottom: 320rpx">
                <view class="content">
                  ...
                  <view class="margin-top"
                    >如开展项目后，需要额外增加功能，需要再次评估并额外支付新功能款项</view
                  >
                </view>
              </view>
            </view>
            ...
            <view class="cu-timeline">
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >网站分企业官网、品牌网站、营销网站、电商网站、门户网站等等，我们主要开发企业官网、官网建设，主要展示企业形象、企业产品和业务、新闻资讯、公司联系信息等。企业网站建设的普遍意义是企业对外宣传交流的窗口</view
                    >
                  </view>
                </view>
              </view>
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >需要确定开发静态官网还是全套，如果是全套，可以先浏览“实战项目”，里面有需要官网案例。</view
                    >
                  </view>
                </view>
              </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >根据功能点和相关实现难点，给予评估报价，实现包括：“原型流程、UI设计、后台开发、前端开发、项目上线”，如果能提供原型流程图，是最好的</view
                    >
                  </view>
                </view>
              </view>
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >开发时长取决于官网设计类型和相关功能点，一般官网开发上线时长约为：1个月内</view
                    >
                  </view>
                </view>
              </view>
            ...
            <view class="cu-timeline">
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    ...
                    <view class="margin-top-sm"
                      >包含资料：智慧社区/物业/小区：PPT（多个）、智慧物业解决方案、功能规划书、业务规划书、可经营项目分析、项目营销方案、市场营销计划书、物业呼叫中心建设方案、智慧小区建设方案等</view
                    >
                    <view class="margin-top-sm"
                      >包含软件：智慧物业管理系统、物业人员App、业主App、业主小程序</view
                    >
                    <view class="margin-top-sm"
                      >包含功能：基础配置、企业管理、门禁管理、通知公告、故障报修、物业缴费、停车管理、财务管理、快递代收、家政服务、巡更管理、违法随手怕、教育服务等</view
                    >
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >项目依托已架设的硬件设备及后台人脸识别服务、车辆信息服务、重点人群数据库、地图数据库等，完成对辖区内目标学校周边可疑人员、车辆的追踪、定位和分析。对“护学岗”工作人员的位置信息追踪，确保护学行动顺利开展。通过摄像头视频及各位置数据的分析，达到有效的预警，以减少针对幼儿、青少年的拐卖、群体事件和交通事故的发生。</view
                    >
                    <view class="margin-top-sm">价格：点击 [业务咨询]，价格面议</view>
                  </view>
                </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >基于小区/商业/路边停车场的建设方案，包含PPT、功能表及功能描述、痛点解决方案、支付相关方案、AI车辆识别等</view
                    >
                    <view class="margin-top-sm">价格：点击 [业务咨询]，价格面议</view>
                  </view>
                </view>
              ...
              <view class="cu-item text-blue">
                <view class="content">
                  ...
                  <view class="margin-top">
                    <view
                      >基于旧物回收建设的软件系统及项目资料，功能包含商家入驻、一键下单、积分商城、权限管理、分佣管理、新闻资讯、车辆管理等模块及业务介绍</view
                    >
                    <view class="margin-top-sm">价格：点击 [业务咨询]，价格面议</view>
                  </view>
                </view>
    ...
    <view class="cu-bar bg-white tabbar shop shadow edit-fixed">
      <button class="action text-gray text-shadow">
        <view class="cuIcon-community text-gray"> </view>
      </button>
