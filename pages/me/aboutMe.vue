...
<template>
  <view class="about">
    ...
    <view class="titleZ text-center align-center">
      ...
      <view class="contentZ">
        <text class="text-xl"
          >项目作者:周凯文，一名6年经验乌黑秀发的九零后web前端程序员，坐标西安，自研项目：「宅家学IT」、「易凯科技」</text
        >
      </view>
    </view>
    ...
    <view class="titleZ text-center align-center margin-top-xl">
      ...
      <view class="contentZ margin-top-lg">
        ...
        <text class="text-xl"
          >：软件技术开发培训（实战项目），1至4个月课程可随意选择，课程包含：UI设计、Web前端、Java后台等，挑战万元月薪，快来宅家学吧～</text
        >
      </view>
      <view class="contentZ" style="margin-top: 40rpx">
        <text class="text-xl text-bold">「易凯科技」</text>
        <text class="text-xl"
          >：承接电商/OA/分销/财务/进销存/ERP系统/H5页面/网站建设/小程序/公众号/App定制开发/名片设计...</text
        >
      </view>
    </view>
    ...
    <button class="" open-type="contact">
      <image
        src="../../static/logo.png"
        class="share-img png round shadow-lg bg-white"
        mode="aspectFit"
      >
      </image>
    </button>
