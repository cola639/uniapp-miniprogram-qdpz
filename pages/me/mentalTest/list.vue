<template>
  <view class="warp">
    ...
    <view class="title b-fontw7"> 答题测试 </view>
    ...
    <view class="nav-box b-card">
      <view class="nav-bar-box">
        <view
          ...
          :key="index"
          :class="{
            'nav-bar-item-check': index == current,
        ...
        >
          ...
          <view class="" style="flex: 1; text-align: center">
            <view class="nav-bar-title">
              {{ item.name }}
              <view class="title-line" v-show="index == current"> </view>
            </view>
          </view>
          <view
            class="nav-bar-line"
            v-if="index < list.length - 1 && index != current && index != current - 1"
          >
          </view>
          <view class=""> </view>
        </view>
      ...
      <view class="nav-content-box">
        <view class="">
          <view class="nav-content-title b-fontw6"> 「每日更新」Web开发面试题 </view>
        ...
        <view class="">
          <view class="img">
            <view class="img-refresh"> 更换答题 </view>
          </view>
        </view>
      </view>

      <view class="nav-btn-box">
        <view class="nav-btn b-fontw6 bg-gradual-blue" @click="goIndex(1)"> 继续答题 </view>
      </view>
    </view>
    ...
    <view>
      ...
      <view
        v-for="(item, index) in dataL.data1"
        :key="index"
        class="cu-list menu sm-border margin-bottom"
        ...
        <view class="cu-item">
          ...
          <view class="action">
            ...
            <button
              v-if="item.isAnswer == 2"
              @click="goIndex(item.id)"
              class="cu-btn round bg-gradual-orange shadow"
            >
              已经答题
            </button>
          </view>
      ...
      <view
        v-for="(item, index) in dataL.data2"
        :key="index"
        class="cu-list menu sm-border margin-bottom"
        style="box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15)"
      >
