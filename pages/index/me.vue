    ...
    >
      ...
      <block>
        <view class="text-center" @click="goMedal">
          ...
          <view
            class="cu-avatar2 round xl margin-right-sm shadow-blur-lg bg-img open-data"
            style="overflow: hidden"
          >
            <image src="../../static/logo.png" style="width: 100%; height: 100%"></image>
          </view>
          <view class="padding text-blue text-xl text-bold"> 你好，开发者！ </view>
        </view>
      </block>
    ...
    <block>
      <view class="padding flex text-center text-grey bg-white shadow-warp-my">
        <view class="flex flex-sub flex-direction solid-right">
          ...
          <view class="margin-top-sm"> <text class="cuIcon-hot"></text> 访客</view>
        </view>
        <view class="flex flex-sub flex-direction solid-right">
          <view class="text-xxl text-blue">15.6k</view>
          <view class="margin-top-sm"> <text class="cuIcon-share"></text> 分享</view>
        </view>
        <view class="flex flex-sub flex-direction">
          <view class="text-xxl text-red">5.5k+</view>
          <view class="margin-top-sm"> <text class="cuIcon-like"></text> 点赞</view>
        </view>
      </view>

      <view
        class="cu-list menu card-menu margin-top-lg shadow-shop bg-white text-black my-radius sm-border"
      >
        ...
        <view class="cu-item">
          <button class="content cu-btn" @tap="showGitee" data-target="ModalGitee">
            <image
              ...
              src="https://zhoukaiwen.com/img/icon/gitee_logo.jpeg"
              class="png"
              mode="aspectFit"
            ></image>
      ...
      <view
        class="cu-list menu card-menu margin-bottom-lg shadow-shop bg-white text-black my-radius sm-border"
      >
        <!-- <view class="cu-item ">
    ...
    <view class="cu-modal" :class="modalName == 'ModalGitee' ? 'show' : ''">
      <view class="cu-dialog">
        ...
        <view style="padding: 10rpx 50rpx 50rpx 50rpx">
          <image
            src="https://cdn.zhoukaiwen.com/logo.png"
            mode="widthFix"
            style="width: 150rpx"
          ></image>
          <view class="text-bold text-xl text-balck margin-top-xs margin-bottom"
            >《前端铺子》· 开源，易上手</view
          >
          <view class="flex justify-between margin-bottom-lg">
            <image
              src="https://svg.hamm.cn/gitee.svg?type=star&user=kevin_chou&project=qdpz"
              mode="heightFix"
              style="height: 40rpx"
            />
            <image
              src="https://svg.hamm.cn/gitee.svg?type=fork&user=kevin_chou&project=qdpz"
              mode="heightFix"
              style="height: 40rpx"
            />
          </view>
