      ...
      <view class="cu-dialog" style="padding: 300rpx 0 70rpx">
        <view class="modal_bg">
          <view class="title-header">
            <view class="title-text"> VIP · 会 · 员 · 说 · 明 </view>
          </view>
        </view>
        <view class="modal_main">
          <view class="padding-lr margin-top-xs">
            <view class="text-grey text-smdf">
              ...
              <text
                >开源不易，<text class="text-orange">感谢大家</text> 对「前端铺子」的支持！</text
              >
            </view>
            ...
            <view class="text-grey text-smdf margin-top-sm">
              <text class="cuIcon-title text-blue margin-right-xs"></text>
              <text
                >会员尊享所有付费组件，同时优先响应会员页面模板需求、项目需求，代开发费用六折！享受外包项目九折优惠！</text
              >
            </view>
            ...
            <view class="text-grey text-smdf margin-top-sm">
              <text class="cuIcon-title text-blue margin-right-xs"></text>
              <text
                >定价也不是很高，统一定价：<text class="text-orange">699元/终身</text
                >（约2个酷炫前端页面价格）‍</text
              >
            </view>
            ...
            <view class="text-grey text-smdf margin-top-sm">
              <text class="cuIcon-title text-blue margin-right-xs"></text>
              <text
                >购买会员，进入会员群，请联系：<text class="text-orange"
                  >280224091‍（微信）</text
                ></text
              >
            </view>
      ...
      <view class="right_box shadow-warp" @click="goBasic">
        <button class="content cu-btn" style="display: contents">
          <view class="text-xxl" style="height: 64rpx; margin-top: 12rpx">
            <image
              src="https://cdn.zhoukaiwen.com/qdpz_hz1.svg"
              mode="widthFix"
              style="width: 65rpx"
            >
            </image>
          </view>
          <view class="text-shadow text-black text-bold" style="font-size: 26rpx; margin-top: 14rpx"
            >更多功能
          </view>
        </button>
      </view>
    ...
    <view class="mainBox flex justify-between">
      ...
      >
        <view style="text-align: center">
          <image
            src="https://cdn.zhoukaiwen.com/qdpz_hbbj3.gif"
            mode="widthFix"
      ...
      >
        <view style="text-align: center">
          <image
            src="https://cdn.zhoukaiwen.com/qdpz_pic1.svg"
            mode="widthFix"
            style="width: 125rpx"
          >
          </image>
    ...
    <view class="padding">
      <view class="flex">
        ...
        >
          <image
            ...
            src="https://cdn.zhoukaiwen.com/qdpz_kt1.svg"
            mode="widthFix"
        ...
        >
          <image
            class="fl margin-right-sm"
            src="https://www.zhoukaiwen.com/img/luck_draw.svg"
            mode="widthFix"
      ...
      <view class="flex">
        ...
        >
          <image
            class="fl margin-right-sm"
            src="https://cdn.zhoukaiwen.com/pic5.svg"
            mode="widthFix"
            style="width: 68rpx; margin-top: 8rpx"
          ></image>
        ...
        >
          <image
            class="fl margin-right-sm"
            src="https://cdn.zhoukaiwen.com/qdpz_vr.svg"
            mode="widthFix"
            style="width: 68rpx; margin-top: 8rpx"
          ></image>
