<template>
  <view class="components-home">
    <view style="margin-top: -50rpx; height: 486rpx; position: relative; margin-bottom: 80rpx">
      <image
        src="https://zhoukaiwen.com/img/wccQQP.png"
        mode="widthFix"
        class="png"
    ...
    <view class="title-header">
      <view class="title-text"> 酷 / 炫 / 组 / 件 </view>
    </view>
    ...
    <view class="nav-list margin-top">
      <navigator
        open-type="navigate"
        hover-class="none"
        :url="'/tn_components/' + item.title"
        :class="'nav-li bg-kuxuan' + (index + 1)"
        v-for="(item, index) in kuxuan"
        :key="index"
      >
    ...
    <view class="title-header">
      <view class="title-text"> 样 / 式 / 模 / 板 </view>
    </view>
    ...
    <view class="nav-list margin-top">
      <navigator
        ...
        hover-class="none"
        :url="'/tn_components/' + item.title"
        :class="'nav-li bg-exper' + (index + 1)"
        v-for="(item, index) in yangshi"
        :key="index"
      >
        <view class="nav-name">{{ item.name }}</view>
      </navigator>
    ...
    <view class="title-header">
      <view class="title-text"> 付 / 费 / 组 / 件 </view>
    </view>
    <view class="nav-list margin-top">
      <navigator
        open-type="navigate"
    ...
    <view class="title-header">
      <view class="title-text"> 设 / 计 / 模 / 版 </view>
    </view>
