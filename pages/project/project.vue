...
<template>
  <view class="container">
    ...
    <view v-if="newsData.title">
      <view style="background-color: #ffffff; padding: 30rpx 30rpx 30rpx 30rpx">
        ...
        <view class="timeBox text-df text-gray margin-top-sm margin-bottom-sm">
          {{ newsData.author }} - {{ newsData.createdAt | formatDate }} -
          {{ newsData.type | typeF }}
        </view>
        ...
        <view class="contentBox text-lg text-black margin-top-sm margin-tb-lg">
          <view
            class="margin-top-sm"
            v-for="(item, index) in newsData.content.split('&')"
            v-html="item"
          >
          </view>
        </view>
      ...
      <view style="background-color: #ffffff; padding: 0rpx 30rpx 30rpx 30rpx">
        ...
        <image
          ...
          v-for="(item, index) in newsData.imgList.split(',')"
          :key="index"
          mode="widthFix"
          :src="item"
        ></image>
        ...
        <view class="text-right text-df text-gray margin-top-sm margin-bottom-sm">
          ...
          <text class="text-df margin-right-sm" style="margin-top: 2rpx">{{
            newsData.seeNum
          }}</text>
    ...
    <view
      style="background-color: #ffffff; padding: 0rpx 30rpx 15rpx0rpx; margin: 25rpx 0 100rpx 0"
    >
      ...
      <view class="cu-list menu-avatar comment solids-top">
        <view class="cu-item">
          <view
            ...
            style="background-image: url(https://cdn.zhoukaiwen.com/logo.png)"
          >
          </view>
          <view class="content">
            <view class="text-grey">凯文童鞋</view>
            <view class="text-gray text-content text-df"> 评论功能暂未开启哦～ </view>
