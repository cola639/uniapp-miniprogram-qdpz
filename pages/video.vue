  ...
  <view class="container">
    <view class="MainBox">
      ...
      <view class="cssBox">
        ...
        <text class="text-df"
          >这是一个很有内容的视频这是一个很有内容的视频这是一个很有内容的视频这是一个很有内容的视频这是一个很有内容的视频这是一个很有内容的视频这是一个很有内容的视频</text
        >
      </view>
        ...
        <view class="cu-card article no-card">
          <view class="cu-item shadow">
            <view class="content" style="padding: 0">
              ...
              <view class="desc">
                <view class="list_title"> 测试标题测试标题测试标题 </view>

                <view class="list_content">
                  折磨生出苦难苦难又会加剧折磨凡间这无穷的循环将有我来终结真正的恩典因不完整而美丽因情感而真诚因脆弱而自由</view
                >
          ...
          <view class="cu-item shadow">
            <view class="content" style="padding: 0">
              <image src="http://cdn.zhoukaiwen.com/web2.jpg" mode="aspectFill"></image>
              <view class="desc">
                <view class="list_title"> 标题标题标题标题 </view>
