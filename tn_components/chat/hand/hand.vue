  ...
  <view>
    ...
    <view class="content" :class="typeClass">
      ...
      <view class="normal">
        ...
        <view class="row">
          <view class="term"> 单个金额 </view>
          <view class="input">
            <input type="number" v-model="money" placeholder="输入金额" /> 元
          </view>
        </view>
        <view class="tis"> 小伙伴领取的金额相同 </view>
        <view class="blessing">
          <input type="text" maxlength="12" placeholder="恭喜发财" v-model="blessing" />
        </view>
        <view class="hand" @tap="hand('normal')"> 发红包 </view>
      </view>
    </view>
  </view>
</template>
