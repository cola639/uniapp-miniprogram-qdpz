  ...
  <view>
    <view class="top">
      ...
      <view class="face" :style="{ 'border-radius': radius }">
        <image src="https://zhoukaiwen.com/img/qdpz/face/face_11.jpg"></image>
      </view>
      <view class="username"> {{ username }}的红包 </view>
    </view>
    <view class="info">
      ...
      <view class="row" v-for="(row, index) in receivedList" :key="index">
        ...
        <view class="right">
          <view class="r1">
            ...
            <view class="money"> {{ row.money }}元 </view>
          </view>
          <view class="r2">
            <view class="time">
              {{ row.time }}
            </view>
            <view class="lucky" v-if="row.islucky"> 手气王 </view>
          </view>
        </view>
      </view>
    </view>
