  ...
  <view class="container">
    ...
    <view class="padding radius bg-white">
      <view class="text-bold text-lg text-black"
        >nitro滑雪鞋 2022-2023雪季新款 step on快穿 23雪季新款 step on快穿</view
      >
    ...
    <view class="bg-white padding margin-top-sm">
      ...
      <view class="flex justify-between margin">
        <view class="text-center text-gray" style="position: relative">
          ...
          <image
            class="rightIcon"
            src="https://cdn.zhoukaiwen.com/icon_right.svg"
            mode="widthFix"
          ></image>
        </view>
    ...
    <view class="bg-white padding-lr padding-bottom text-df">
      <view class="padding-xs">
        <text class="text-grey" style="display: inline-block; width: 130rpx; letter-spacing: 1rpx"
          >品牌型号</text
        >
    ...
    <view class="bg-white padding">
      <view class="padding">
        <image
          src="https://zhoukaiwen.com/img/qh/dior.jpg"
          style="width: 100%"
          mode="widthFix"
        ></image>
      </view>
    ...
    <view
      class="cu-bar bg-white tabbar border shop solid-top"
    ...
    >
      ...
      <view class="action text-orange"> <view class="cuIcon-favorfill"></view> 已收藏 </view>
