<template>
  <view class="warp">
    ...
    <view class="exchange-box">
      <view class="title">
        <image
          ...
          src="https://zhoukaiwen.com/img/clockImg/icon-money.png"
          mode=""
        ></image>
        <view style="line-height: 50rpx; margin: 0 10rpx"
          >可用金币：
          <u-count-to
            :start-val="total_start"
            :end-val="total"
            color="#fff"
            font-size="36"
          ></u-count-to>
    ...
    <view class="signIn-box b-card">
      <view class="signIn-heard">
        <view class="title">
          ...
          <view class="title-tomorrow"> 明日签到可获得10金币 </view>
        </view>
        ...
        <view class="item">
          ...
          <view class="b-flex-space">
            <view class="card" style="width: 100%; display: flex; justify-content: space-between">
              ...
              <image
                class="img"
                style="width: 120rpx; height: 110rpx; margin-top: 20rpx"
                src="https://zhoukaiwen.com/img/clockImg/icon-gift.png"
                mode=""
              ></image>
            </view>
          </view>
    ...
    <view class="task-box b-card">
      <view class="title b-fontw"> 做任务赚金币 </view>

      <view class="task-item b-flex-space">
        <view class="task-item-left b-flex-space">
          <image
            class="task-item-icon"
            src="https://zhoukaiwen.com/img/clockImg/icon-signs.png"
            mode=""
          ></image>
          <view class="task-item-describe">
            <view class="title b-fontw"> 累计签到3天 </view>
            <view class="text"> 连续签到3天额外获取20金币 </view>
          </view>
        </view>
      ...
      <view class="task-item b-flex-space">
        <view class="task-item-left b-flex-space">
          ...
          ></image>
          <view class="task-item-describe">
            <view class="title b-fontw"> 累计签到7天 </view>
            <view class="text"> 连续签到7天额外获取50金币 </view>
          </view>
        </view>
        <view class="task-item-btn">
          <image
      ...
      <view class="task-item b-flex-space">
        <view class="task-item-left b-flex-space">
          <image
            class="task-item-icon"
            src="https://zhoukaiwen.com/img/clockImg/icon-takeOut.png"
            mode=""
          ></image>
          <view class="task-item-describe">
            <view class="title b-fontw"> 完成2单外卖订单 </view>
            <view class="text"> 在线点单外卖配送2单 </view>
          </view>
        </view>
        <view class="task-item-btn">
          <image
      ...
      <view class="task-item b-flex-space">
        <view class="task-item-left b-flex-space">
          <image
            class="task-item-icon"
            src="https://zhoukaiwen.com/img/clockImg/icon-since.png"
            mode=""
          ></image>
          <view class="task-item-describe">
            <view class="title b-fontw"> 完成2单自提 </view>
            <view class="text"> 线上下单，到店自提 </view>
          </view>
        </view>
        <view class="task-item-btn">
          <image
