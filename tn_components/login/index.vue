    ...
    <view class="padding-lr-sm padding-top-sm bg-white">
      <view class="newsListBox bg-white">
        <view class="newsList radius shadow-warp padding-bottom-xs" @click="goIndex1">
          ...
          <view class="text-bold text-black text-shadow padding-top-xs padding-lr-sm"
            >简洁风格登录页</view
          >
          <view class="flex justify-between margin-top-xs">
            <view class="text-bold text-sm text-grey padding-tb-xs padding-left-sm">
              <view
                class="cu-avatar round margin-right-xs sm"
                :style="[{ backgroundImage: 'url(https://cdn.zhoukaiwen.com/logo.png)' }]"
              ></view>
              <text>前端铺子</text>
            </view>
            <view class="text-xs text-grey padding-right-sm" style="line-height: 60rpx"
              >2020-07-11</view
            >
          </view>
        </view>
