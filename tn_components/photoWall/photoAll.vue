  ...
  <view class="contaier">
    <view class="text-xxl" style="height: 770rpx; position: relative">
      ...
      <text
        @click="goBack"
        class="cuIcon-back"
        style="position: absolute; left: 40rpx; top: 70rpx; color: #000000"
      ></text>
    ...
    <view
      class="image-piccapsule"
      style="background-image: url(https://cdn.zhoukaiwen.com/jiaonangtu.png)"
    >
    ...
    <view class="cu-list menu-avatar margin-bottom">
      <view class="cu-item" @click="goTimeLine">
        <view
          ...
          style="background-image: url(https://cdn.zhoukaiwen.com/aoshan.jpg)"
        ></view>
        <view class="content">
      ...
      <view class="cu-item" @click="goTimeLine">
        <view
          class="cu-avatar radius lg"
          style="background-image: url(https://cdn.zhoukaiwen.com/fulong.png)"
        ></view>
        <view class="content">
