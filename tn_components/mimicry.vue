  ...
  <view class="components-mimicry">
    ...
    <view class="padding-top-sl">
      <swiper
        ...
        duration="500"
        @change="bannerSwiper"
        indicator-color="#1b6cff"
        indicator-active-color="#1b6cff"
      >
        <!-- #ifdef H5 -->
        <swiper-item
          v-for="(item, index) in bannerimg"
          :key="'banner' + index"
          :class="[bannerCur == index ? 'cur' : '']"
        >
          <view
            class="swiper-item bg-img shadow-blur"
    ...
    <view class="">
      <view class="">
        <image
          class="banner-index"
          mode="aspectFit"
          src="https://s1.ax1x.com/2020/06/25/N01gkd.png"
        >
        </image>
      </view>
    </view>
    ...
    <view class="title-header">
      <view class="title-text"> 口 / 碑 / 推 / 荐 </view>
    </view>

    <view class="padding-sm">
      <view class="flex">
        <view
          class="flex-twice bg-white margin-xs bg-img shadow-blur radius-index solid mimicry"
        ...
        <view class="flex-sub radius margin-right-xs margin-left-sm">
          <view
            class="flex-sub bg-white margin-top-xs bg-img shadow-blur radius-index solid mimicry"
            style="height: 150rpx; background-image: url(https://s1.ax1x.com/2020/06/25/N03uHe.jpg)"
          ></view>
          <view
            class="flex-sub bg-white margin-top bg-img shadow-blur radius-index solid mimicry"
            style="height: 150rpx; background-image: url(https://s1.ax1x.com/2020/06/25/N03iN9.jpg)"
          ></view>
        </view>
      </view>
    </view>
    ...
    <view class="title-header">
      <view class="title-text"> 特 / 价 / 清 / 货 </view>
    </view>
    <view class="cu-card">
      <view
        class="cu-item bg-img mimicry"
        style="background-image: url(https://s1.ax1x.com/2020/06/25/N03MAH.jpg)"
      >
        <view class="cardTitlebig"> 可我会像 </view>
      </view>
    </view>
    ...
    <view class="cu-card" style="margin-top: -30rpx">
      ...
      >
        <view class="cardTitle"> 可我会像 </view>
      </view>
      <view
        class="cu-item bg-img mimicry"
    ...
    <view class="title-header">
      <view class="title-text"> 爆 / 款 / 靓 / 品 </view>
    </view>
          ...
          >
            <navigator url="/pages/product/product" hover-class="none">
              <view class="grid col-1 grid-square flex-sub">
                <view
                  class="bg-img product-border shadow"
                  :style="'background-image:url(' + item.url + ');'"
                >
              ...
              <view class="grid col-1 margin-bottom">
                <view class="">
                  <view class="text-xl product-title tn-align">
                    <text class="text-black index-title text-df name-title-a">{{
                      item.title
                    }}</text>
                  </view>
    ...
    <view class="cu-bar tabbar foot tarbar-mimicry">
      <view class="action navbar__item -blue">
        ...
        <view class="cu-avatar sm round avatar -blue shadow"
          ><text
            class="text-balck cuIcon-name text-sm"
            style="margin-bottom: -40px; font-size: 20rpx; color: #303030"
            >首页</text
          ></view
        >
      </view>
      <view class="action navbar__item -orange">
        <view class="cuIcon-discover text-bold navbar__icon icon"> </view>
        <view class="cu-avatar sm round avatar -orange shadow"
          ><text
            class="text-balck cuIcon-name text-sm"
            style="margin-bottom: -40px; font-size: 20rpx; color: #303030"
            >发现</text
      ...
      <view class="action navbar__item -yellow">
        <view class="cuIcon-cart text-bold navbar__icon icon"> </view>
        <view class="cu-avatar sm round avatar -yellow shadow"
          ><text
            class="text-balck cuIcon-name text-sm"
            style="margin-bottom: -40px; font-size: 20rpx; color: #303030"
            >购物</text
      ...
      <view class="action navbar__item -purple">
        ...
        <view class="cu-avatar sm round avatar -purple shadow"
          ><text
            class="text-balck cuIcon-name text-sm"
            style="margin-bottom: -40px; font-size: 20rpx; color: #303030"
            >你的</text
