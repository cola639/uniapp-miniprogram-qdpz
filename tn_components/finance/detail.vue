    ...
    <view class="topBox">
      ...
      <view class="topMainBox flex flex-direction justify-between viewBox">
        <view class="padding-lr padding-tb-sm">
          <view
            class="isHead cu-avatar lg round margin-left"
            style="
    ...
    <view>
      <view class="padding-lr-sm margin-bottom-sm">
        ...
        <view class="cu-form-group radius margin-top-xs topBg">
          <input placeholder="请输入分配资金" name="input" type="number" />
      ...
      <view class="padding-lr-sm margin-bottom-sm">
        ...
        <view class="cu-form-group radius margin-top-xs topBg">
          <input placeholder="请输入杠杆" name="input" type="number" />
        </view>
      </view>
      <view class="padding-lr-sm margin-bottom-sm">
        <text class="inputName text-bold text-df">仓位比例</text>
        <view class="cu-form-group radius margin-top-xs topBg">
          <input placeholder="请输入仓位比例" name="input" type="number" />
        </view>
      </view>
      <view class="padding-lr-sm margin-bottom-sm">
        <text class="inputName text-bold text-df">保证金模式</text>
        <view class="cu-form-group radius margin-top-xs topBg">
          <input disabled v-model="type1[type1Index]" name="input" />
          <picker @change="type1Change" :value="type1Index" :range="type1">
            <view class="picker text-grey text-sm"> 全仓 </view>
          </picker>
        </view>
      </view>
      <view class="padding-lr-sm margin-bottom-sm">
        ...
        <view class="cu-form-group radius margin-top-xs topBg">
          <input disabled placeholder="请输入仓位比例" v-model="type2[type2Index]" name="input" />
          <picker @change="type2Change" :value="type2Index" :range="type2">
            <view class="picker text-grey text-sm"> 固定(每次仓位相同) </view>
          </picker>
        </view>
      </view>
