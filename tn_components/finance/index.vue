  ...
  <view class="container">
    <view class="topBox">
      ...
      <view class="padding-lr">
        <view
          class="topHead cu-avatar round xl"
          style="
        ...
        <view class="text-bold text-sm text-center margin-top-sm text-white"
          >这是前端铺子组件部分</view
        >
      </view>
    </view>
    ...
    <view style="padding-bottom: 120rpx">
      ...
      <view class="padding-lr-sm text-sm viewBox">
        ...
        <text
          v-show="notesType != -1"
          @click="notesALl()"
          class="text-grey margin-left-xs text-bold"
        >
          {{ notesType == 0 ? '收起' : '展开' }}
        </text>
      </view>
      ...
      <scroll-view scroll-x class="nav text-left margin-bottom-sm viewBox">
        <view
          class="cu-item"
          :class="index == TabCur ? 'text-yellow cur text-bold' : ''"
          ...
          <view class="flex justify-between padding-sm">
            <view class="flex justify-between flex-direction">
              <view>
                ...
                <view
                  class="cu-tag radius light bg-cyan sm margin-left-xs"
    ...
    <view class="bottomButton cu-bar topBg tabbar border shop">
      <button class="action" open-type="contact"><view class="cuIcon-favor"> </view> 订阅</button>
      <view @click="goUsePloy" class="btn-group">
        <button class="cu-btn bg-yellow shadow-blur margin-bottom-sm text-bold" style="width: 85%">
          跟单
        </button>
      </view>
    </view>
...
export default {
  data() {
    return {
      ...
      notesData:
        '这是一段数据加载的描述,这是一段数据加载的描述,这是一段数据加载的描述,这是一段数据加载的描述,这是一段数据加载的描述,这是一段数据加载的描述，这是一段数据加载的描述',
