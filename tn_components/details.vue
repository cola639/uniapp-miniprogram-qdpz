  ...
  <view class="container">
    ...
    <view class="bg-top bg-blue">
      <view class="top-box shadow">
        <view
          class="qh-pic cu-avatar xl"
          style="background-image: url(https://zhoukaiwen.com/img/kevinLogo.png)"
        ></view>
        ...
        <view class="cu-list menu">
          <view class="cu-item" style="padding: 0">
            <view class="content margin-top" style="display: flex; justify-content: space-around">
              ...
              <text
                ...
                style="min-width: 290rpx; max-width: 290rpx; text-align: left"
                >陕西省西安市莲湖区</text
              >
          ...
          <view class="cu-item" style="padding: 0">
            ...
            <view class="action">
              ...
              >
                <image
                  v-for="(item, index) in joinList.length"
                  :key="index"
                  style="width: 42rpx; height: 42rpx; float: left; margin: 0 2rpx"
                  src="https://www.zhoukaiwen.com/img/icon/qh_applet/icon/icon_zuowei_2.png"
                  mode=""
                >
                </image>
                <image
                  v-for="(item, index) in 4 - joinList.length"
                  :key="index"
                  style="width: 42rpx; height: 42rpx; float: left; margin: 0 2rpx"
                  src="https://www.zhoukaiwen.com/img/icon/qh_applet/icon/icon_zuowei_1.png"
                  mode=""
                >
                </image>
              </view>
          ...
          <view class="cu-item" style="padding: 0">
            ...
            <view class="cu-capsule radius margin-right">
              ...
              <view class="cu-tag line-green"> 可吃零食 </view>
            </view>
            ...
            <view class="cu-capsule radius">
              ...
              <view class="cu-tag line-red"> 不可吸烟 </view>
            </view>
          </view>
          ...
          <view class="padding-bottom-sm flex flex-wrap bg-white" style="justify-content: flex-end">
            <view class="cu-tag margin-right-xs bg-blue light radius"> 社交牛逼症 </view>
            <view class="cu-tag bg-purple light radius"> 全程可陪聊 </view>
            <view class="cu-tag bg-brown light radius"> 进藏老司机 </view>
            <view class="cu-tag bg-green light radius"> 脾气好 </view>
          </view>
          ...
          <view class="padding-bottom-sm padding-left-sm bg-white"> 这是一段备注信息 </view>
        </view>
      </view>
        ...
        <view class="cu-list menu">
          ...
          <view class="cu-item" style="padding: 0">
            <view class="content">
              <image
                src="../static/logo.png"
                class="png cu-avatar round sm"
                mode="aspectFit"
              ></image>
              <text class="text-lg">凯文童鞋</text>
            </view>
            <view class="action">
              <view class="cu-tag radius bg-blue light"> 186****1093 </view>
          ...
          <view class="cu-item" style="padding: 0">
            <view class="content">
              <image
                src="https://zhoukaiwen.com/img/koalaBillLogo.jpg"
                class="png cu-avatar round sm"
                mode="aspectFit"
              ></image>
            ...
            <view class="action">
              <view class="cu-tag radius bg-blue light"> 133****1323 </view>
              <button class="cu-btn round sm shadow bg-red margin-left">请离</button>
            </view>
          </view>
        </view>
      ...
      <view class="center-box shadow">
        <view class="cu-list menu">
          ...
          <view class="cu-item" style="padding: 0">
            ...
            <view class="action">
              <view class="cu-tag round bg-blue light"> 177 **** 1131 </view>
            </view>
          </view>
        </view>
      </view>
      ...
      <view class="padding-lr" style="margin-top: 15rpx; margin-bottom: 30rpx">
        <text class="text-grey text-sm"
          >"上车" 即可查看发布者信息，为保证您的拼单，请与发布者确认</text
        >
      </view>
    </view>
  </view>
