    ...
    <view class="mainBox">
      ...
      <form>
        <view class="cu-form-group">
          ...
          <input placeholder="请填写计划名称" value="" name="input" />
        </view>
      ...
      <view class="cu-list menu" style="border-bottom: 3rpx solid #eeeeee">
        <view class="cu-item">
          ...
          <view class="action" style="position: relative">
            ...
            <text
              @click="addList()"
              style="font-size: 38rpx; position: absolute; bottom: -6rpx; right: -16rpx"
              class="text-green cuIcon-roundadd text-bold"
            ></text>
          </view>
        </view>
      </view>
      <form>
        <view v-for="(item, indexs) in listData" :key="indexs">
          <view class="cu-list menu">
            <view class="cu-item">
              ...
              <view class="action" style="position: relative">
                <text
                  @click="removeList()"
                  style="font-size: 38rpx; position: absolute; bottom: -24rpx; right: -16rpx"
                  class="text-red cuIcon-roundclose text-bold"
                ></text>
              </view>
            </view>
          </view>
          ...
          <view class="cu-form-group">
            ...
            <input placeholder="请填写预算量" value="" name="input" />
          </view>
        </view>
      </form>

      <view style="padding: 12rpx 5rpx 24rpx" class="text-lg text-black text-bold text-right"
        >合计预算量：<text class="text-blue">00m³</text></view
      >
    </view>
