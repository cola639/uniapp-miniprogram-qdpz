export default [
  {
    ...
    introduceText: {
      ...
      projDescribe:
        '数据可视化大屏电子沙盘集合，基于：html/dataV/Echarts等等，包含行业：区块链金融行业、智慧社区、智慧物业、智慧政务、智慧交通、通用模板等，包含功能：自定义字体、Css动画、WebSocket实时数据、K线折线等各种图表，iframe嵌套H5/App，替换js数据即可，满足您会议展览、业务监控、风险预警、数据分析展示等多种展示需求🔝 Gitee点个 Star 关注更新，笔芯♥️～',
      commercial: '可商用',
      projPrice: '0元',
  ...
  },
  {
    ...
    introduceImg: ['https://cdn.zhoukaiwen.com/project1.jpeg']
  },
  {
    id: 2,
    title: '个人博客系统',
  ...
  },
  {
    ...
    introduceText: {
      ...
      projDescribe:
        'ToG项目，告别纸质录入、拒绝信息繁杂、实现数据共享，为解决GongAn部门制作的一款软件，同时包含App网格员端',
